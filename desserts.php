...
<?php include_once('inc/nav.php'); ?>
    ...
    <div class="container ">
        <div class="card-columns">
            ...
            $product_array = $productController->getProductByCategory("dessert");
                ...
                <div class="card text-white bg-dark mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <form method="post" action="desserts.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
